...
public class MovimentacaoDoJogador : MonoBehaviour
{
    ...
    private void Update()
    {
        // if (!ControladorDeJogo.Instance.PodeFazerInteracaoNormal()) return;
    ...
    private void TentarMover(Vector2Int direcao)
    {
        ...
        if (celulaAlvo != null && (celulaAlvo.tipo == TipoDeCelula.Arvore || celulaAlvo.tipo == TipoDeCelula.Broto))
        {
